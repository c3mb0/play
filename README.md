...
Both modes ultimately delivered the same `h\n`. Kernel readback and receipt
phase ordering verified the controlled change.
[Results](experiments/canonical_001/RESULT.md).
